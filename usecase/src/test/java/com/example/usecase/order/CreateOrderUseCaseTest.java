...
class CreateOrderUseCaseTest {
  ...
  void createOrder_ValidData_CreatesOrderAndUpdatesInventory() throws Exception {
    ...
    Inventory updatedInventory =
        new Inventory(inventoryId, inventoryName, initialQuantity - orderQuantity);
  ...
  void createOrder_InventoryNotFound_ThrowsInventoryNotFoundException() {
    ...
    // Act & Assert
    assertThrows(InventoryNotFoundException.class, () -> useCase.createOrder(inventoryId, data));
  }
  ...
  void createOrder_InsufficientInventory_ThrowsInventoryIrreducibleException() {
    ...
    // Act & Assert
    assertThrows(InventoryIrreducibleException.class, () -> useCase.createOrder(inventoryId, data));
  }
  ...
  void createOrder_NegativeQuantity_ThrowsDomainValidationException() {
    ...
    // Act & Assert
    assertThrows(DomainValidationException.class, () -> useCase.createOrder(inventoryId, data));
  }
